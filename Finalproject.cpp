...
//Developer : MOHAMMED AHMED HUSSEIN GEABEL
// student number: B221200576
// Homework Number: 3
// Topic: Order Planning
...
int main()
 {
   ...
   while (i<10)
   {
    ...
    for ( i = 0; i < n; i++)
    {
        toplam+=first.Amount[i];
    }
    
    cout<<"_________________________________________"<<endl;
    outputFile<<"_________________________________________"<<endl;
    cout<<"Toplam Amount: "<< toplam << endl;
    outputFile<<"Toplam Amount: "<< toplam << endl;
    //close the text_file
